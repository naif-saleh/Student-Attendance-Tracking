        ...
        <div class="bg-white rounded-xl shadow-xs p-4 sm:p-7 dark:bg-neutral-800">
            <div class="mb-8">
                ...
                <p class="text-sm text-gray-600 dark:text-neutral-400">
                    Update Student Class Information Here.
                </p>
            </div>
            ...
            <form wire:submit=update>
                ...
                <div class="mt-5 flex justify-end gap-x-2">
                    ...
                    <button type="submit" 
                        ...
                        <div class="animate-spin inline-block size-6 border-3 border-current border-t-transparent text-blue-600 rounded-full dark:text-blue-500" role="status" aria-label="loading" wire:loading>
